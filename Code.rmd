...
# Boxplots of Water Intake by Groups
``` {r}

# Gender
ggplot(gym, aes(x = Gender, y = `Water_Intake (ounces)`, fill = Gender)) +
  geom_boxplot(alpha = 0.7) +
  labs(title = "Water Intake by Gender",
       x = "Gender",
       y = "Water Intake (ounces)") +
  theme_minimal()

# Age Group
ggplot(gym, aes(x = Group, y = `Water_Intake (ounces)`, fill = Group)) +
  geom_boxplot(alpha = 0.7) +
  labs(title = "Water Intake by Age Group",
       x = "Age Group",
       y = "Water Intake (ounces)") +
  theme_minimal()

# Weight Group
ggplot(gym, aes(x = Group_WGT, y = `Water_Intake (ounces)`, fill = Group_WGT)) +
  geom_boxplot(alpha = 0.7) +
  labs(title = "Water Intake by Weight Group",
       x = "Weight Group",
       y = "Water Intake (ounces)") +
  theme_minimal()
```
